...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_D3D11_BUFFER_CREATE_INFO_JUICE = 1000399000,
    VK_STRUCTURE_TYPE_DXVK_BUFFER_CREATE_INFO_JUICE = 1000399001,
    VK_STRUCTURE_TYPE_MESA_BUFFER_CREATE_INFO_JUICE = 1000399002,
    VK_STRUCTURE_TYPE_D3D11_IMAGE_CREATE_INFO_JUICE = 1000399003,
    VK_STRUCTURE_TYPE_DXVK_IMAGE_CREATE_INFO_JUICE = 1000399004,
    VK_STRUCTURE_TYPE_DXVK_COPY_INFO_JUICE = 1000399005,
...
typedef enum VkDxvkTypeJUICE {
    ...
    VK_DXVK_TYPE_D3D11_STAGING_BUFFER_JUICE = 1,
    VK_DXVK_TYPE_D3D11_SHADER_CONSTANTS_BUFFER_JUICE = 2,
    VK_DXVK_TYPE_D3D11_TEXTURE_BUFFER_JUICE = 3,
    VK_DXVK_TYPE_D3D11_UAV_COUNTER_BUFFER_JUICE = 4,
    VK_DXVK_TYPE_D3D11_SO_COUNTER_BUFFER_JUICE = 5,
    VK_DXVK_TYPE_TEMPORARY_COPY_BUFFER_JUICE = 6,
    VK_DXVK_TYPE_STAGING_BUFFER_JUICE = 7,
    VK_DXVK_TYPE_UNBOUND_BUFFER_JUICE = 8,
    VK_DXVK_TYPE_HUD_BUFFER_JUICE = 9,
    VK_DXVK_TYPE_ZERO_BUFFER_JUICE = 10,
    VK_DXVK_TYPE_SLICE_VERTEX_BUFFER_JUICE = 11,
    VK_DXVK_TYPE_SLICE_UPDATE_SHADOW_BUFFER_JUICE = 12,
    VK_DXVK_TYPE_IMMEDIATE_MAP_DISCARD_BUFFER_JUICE = 13,
    VK_DXVK_TYPE_IMMEDIATE_MAP_DISCARD_IMAGE_JUICE = 14,
    VK_DXVK_TYPE_DEFERRED_MAP_DISCARD_BUFFER_JUICE = 15,
    VK_DXVK_TYPE_SLICE_MAP_BUFFER_JUICE = 16,
    VK_DXVK_TYPE_UNBOUND_IMAGE_JUICE = 17,
    VK_DXVK_TYPE_HUD_FONT_IMAGE_JUICE = 18,
    VK_DXVK_TYPE_RESOLVE_IMAGE_JUICE = 19,
    VK_DXVK_TYPE_GAMMA_IMAGE_JUICE = 20,
    VK_DXVK_TYPE_TEMPORARY_COPY_IMAGE_JUICE = 21,
