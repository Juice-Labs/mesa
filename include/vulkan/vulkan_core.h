...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_D3D12_HEAP_CREATE_INFO_JUICE = 1000399001,
    VK_STRUCTURE_TYPE_D3D12_BUFFER_VIEW_CREATE_INFO_JUICE = 1000399002,
    VK_STRUCTURE_TYPE_D3D12_BIND_BUFFER_VIEW_INFO_JUICE = 1000399003,
    VK_STRUCTURE_TYPE_D3D12_BIND_IMAGE_VIEW_INFO_JUICE = 1000399004,
    VK_STRUCTURE_TYPE_D3D11_BUFFER_CREATE_INFO_JUICE = 1000399005,
    VK_STRUCTURE_TYPE_DXVK_BUFFER_CREATE_INFO_JUICE = 1000399006,
    VK_STRUCTURE_TYPE_MESA_BUFFER_CREATE_INFO_JUICE = 1000399007,
    VK_STRUCTURE_TYPE_D3D11_IMAGE_CREATE_INFO_JUICE = 1000399008,
    VK_STRUCTURE_TYPE_DXVK_IMAGE_CREATE_INFO_JUICE = 1000399009,
    VK_STRUCTURE_TYPE_DXVK_COPY_INFO_JUICE = 1000399010,
...
typedef enum VkMesaUsageFlagBitsJUICE {
    ...
    VK_MESA_USAGE_STREAM_BIT_JUICE = 0x00000002,
    VK_MESA_USAGE_BIND_LINEAR_BIT_JUICE = 0x00000004,
